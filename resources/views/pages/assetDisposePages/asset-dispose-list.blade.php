    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Asset Dispose List</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="card c-shadow">
              <div class="card-body">
                <h5 class="card-title">Asset Dispose List</h5>
                ...
                <table id="datatable" class="table table-striped table-bordered datatable">
                  ...
                  <tbody>
                    @foreach ($assetDisposeDetailsList as $detail)
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a href="{{ route('assetDispose-edit',$detail->id) }}"><span class="badge rounded-pill text-bg-info">Approve/Decline</span></a>
                          
                            <a onclick="return confirm('Are you sure to delete ?')" href="{{ url('asset-dispose-delete/'.$detail->id) }}" class="badge rounded-pill text-bg-danger">Delete</a>              
                          </td>
                        </tr>
                    @endforeach
                  </tbody>
