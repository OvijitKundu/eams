    ...
    <h1>Maintenance Workbench Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> Maintenance Pending</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <div class="row">
        <div class="col-lg-12">
          <div class="card c-shadow">
            <div class="card-body">
              <h5 class="card-title">Maintenance Remaining </h5>
                  ...
                  @foreach ($org_workorder as $result)
                      <tr>
                          ...
                          <td class="text-center">
                              <a href="{{ route('workorder-maintenance',$result->id) }}"><span class="badge rounded-pill text-bg-info">GO</span></a>
